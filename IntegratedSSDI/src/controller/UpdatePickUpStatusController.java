...
public class  UpdatePickUpStatusController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServicesDao serviceDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePickUpStatusController() {
        super();
	        ...
	        try  {
	        	...
	        	for (String selectedItem : selectedOrders) {
	        	    ...
	        	    orders.add(order);
	                 ...
	                 int flag = serviceDao.updatePickup(orders,username);
	                 RequestDispatcher rd = null;
	                 if (flag != 0)
	                 {    //request.setAttribute("",store_id);
	                	 String str = " Orders status  not updated Successfully";
		                 request.setAttribute("msg", str);
	                 rd=request.getRequestDispatcher("/UpdatePickUp.jsp");  
