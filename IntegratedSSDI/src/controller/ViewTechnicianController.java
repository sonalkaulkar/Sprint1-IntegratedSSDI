...
public class ViewTechnicianController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServicesDao serviceDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewTechnicianController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	     ...
	     //     List errorMsgs = new  LinkedList();
	        ...
	        //  PrintWriter out = response.getWriter();
	          tlist  = serviceDao.viewtechnician(username);
	                 RequestDispatcher rd = null;
	                 request.setAttribute("technician", tlist);
	                 RequestDispatcher rd1=request.getRequestDispatcher("/viewTechnician.jsp");
