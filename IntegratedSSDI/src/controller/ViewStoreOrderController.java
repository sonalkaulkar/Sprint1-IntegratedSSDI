...
public class ViewStoreOrderController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServicesDao serviceDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewStoreOrderController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	     ...
	     //     List errorMsgs = new  LinkedList();
	        ...
	        //  PrintWriter out = response.getWriter();
	          plist  = serviceDao.viewStoreOrder(username);
	              
	                 request.setAttribute("order", plist);
	                 RequestDispatcher rd1=request.getRequestDispatcher("/StrManagerViewOrders.jsp");
