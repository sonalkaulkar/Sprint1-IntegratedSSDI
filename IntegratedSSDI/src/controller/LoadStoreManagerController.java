...
public class LoadStoreManagerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServicesDao serviceDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadStoreManagerController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	     ...
	     //     List errorMsgs = new  LinkedList();
	          ...
	          //PrintWriter out = response.getWriter();
	         Store sdetails  = serviceDao.loadstoremanagerdetails(s);
	         
	                 RequestDispatcher rd = null;
	                 request.setAttribute("storedet", sdetails);
	                
	                 RequestDispatcher rd1=request.getRequestDispatcher("/ManagerDetails.jsp");
