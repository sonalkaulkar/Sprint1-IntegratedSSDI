...
public class ViewDeliveredController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServicesDao serviceDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewDeliveredController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		    ...
		    //          out.print("Hello, "+username); 
	        	System.out.println("inside view delivered controller");
	     ...
	     //     List errorMsgs = new  LinkedList();
	        ...
	        //  PrintWriter out = response.getWriter();
	          plist  = serviceDao.viewDelivered(username);
	              
	                 request.setAttribute("order", plist);
	                 RequestDispatcher rd1=request.getRequestDispatcher("/DeliveryOrdersClose.jsp");
